...
INPUT_REGISTERS = {
    ...
    "Var1Value": (102, 1, RegType.UINT, int),
    "Var2Value": (103, 1, RegType.UINT, int),
    "Var1Address": (104, 1, RegType.UINT, int),
    "Var2Address": (105, 1, RegType.UINT, int),
    "Var1Setting": (106, 1, RegType.UINT, int),
    "ChipSelect": (107, 1, RegType.UINT, int),
}
